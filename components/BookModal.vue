          ...
          <TransitionChild enter="duration-300 ease-out" enter-from="opacity-0 scale-95"
            ...
            <DialogPanel class="w-full min-w-[360px] p-5 bg-white shadow-lg rounded-2xl">
              <div class="flex items-center justify-between">
                ...
                <DialogTitle class="text-xl font-medium text-gray-700">{{ book._id ? "Update" : "Create" }} Author
                </DialogTitle>
              </div>
              ...
              <form @submit="submitBook" class="mt-5">
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <div class="col-span-1">
                    <FormInput min="0" rules="required|min_value:0" label="Page count" type="number" name="pageCount"
                      id="count" />
                  </div>
                </div>
                <!-- Form buttons -->
